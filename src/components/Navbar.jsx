  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-700 ${
      ...
      <div className="flex justify-between items-center w-full px-6 md:px-12 py-4 md:py-6 max-w-[1920px] mx-auto">
        <Link to="/" className={`text-xl md:text-2xl font-light tracking-tighter font-headline transition-colors duration-700 ${
        ...
        <div className="hidden md:flex items-center space-x-12">
          <Link to="/" className={`font-medium border-b font-label tracking-widest text-xs uppercase whitespace-nowrap transition-all duration-700 ease-in-out hover:tracking-[0.2em] ${
            transparent ? 'text-white/90 border-white/30 hover:text-white' : 'text-primary border-slate-900/20 hover:text-primary'
          }`}>
            Obras Selectas
          </Link>
